...
export class AcousticNessService {
  ...
  acousticWaves = {
    topleft: {
      low: '<path class="acoustic" d="M116.33,42.43c-12.11-3.2-28.67,5.36-33.34,16.72"/>',
      mid: '<path class="acoustic" d="M111.33,37.43c-12.11-3.2-28.67,5.36-33.34,16.72"/>',
      high: '<path class="acoustic" d="M106.33,32.43c-12.11-3.2-28.67,5.36-33.34,16.72"/>',
    },
    topright: {
      low: '<path class="acoustic" d="M326.61,42.21c12.11-3.2,28.67,5.36,33.34,16.72"/>',
      mid: '<path class="acoustic" d="M331.61,37.21c12.11-3.2,28.67,5.36,33.34,16.72"/>',
      high: '<path class="acoustic" d="M336.61,32.26c12.11-3.2,28.67,5.36,33.34,16.72"/>',
    },
    bottomright: {
      low: '<path class="acoustic" d="M326.61,344.17c12.11,3.2,28.67-5.36,33.34-16.72"/>',
      mid: '<path class="acoustic" d="M331.61,349.17c12.11,3.2,28.67-5.36,33.34-16.72"/>',
      high: '<path class="acoustic" d="M336.61,354.17c12.11,3.2,28.67-5.36,33.34-16.72"/>',
    },
    bottomleft: {
      low: '<path class="acoustic" d="M116.33,344.17c-12.11,3.2-28.67-5.36-33.34-16.72"/>',
      mid: '<path class="acoustic" d="M111.33,349.17c-12.11,3.2-28.67-5.36-33.34-16.72"/>',
      high: '<path class="acoustic" d="M106.33,354.17c-12.11,3.2-28.67-5.36-33.34-16.72"/>',
    }
  }

  acousticSpeakers = {
    left: {
      low: '<path style="fill:var(--speaker-left);" d="M103.29,206l-20.9,-10.3l0,32l20.9,10.6l0,-32.3z" /> <path style="fill:var(--speaker-right);" d="M103.29,206l0,32.3l21.3,-10.7l0,-32l-21.3,10.4z" /> <path style="fill:var(--speaker-top);" d="M82.39,195.7l20.9,10.3l21.3,-10.4l-21.3,-10.4l-20.9,10.5z" /> <path style="stroke:var(--speaker-handle);fill:none;" d="M95.39,218.2l-5.8,-3.2l0,-5.3l5.8,3.1l0,5.4z" /> <g class="speakercircle"> <path d="M114.09,217.3c-.6,.3-2.1,1.2-3,3-.8,1.5-.8,2.9-.8,3.5,0,.1,0,1.4,1.1,2.2,.8,.5,1.8,.6,2.7,.1,.6-.3,1.8-1.1,2.7-2.6,1.1-1.7,1.2-3.4,1.2-4.1,0-.4-.1-1.1-.6-1.6-.8-.7-2.1-1-3.3-.5Z" /> <path d="M114.09,213.5c-1.1,.5-3.9,2.2-5.7,5.7-1.4,2.8-1.5,5.3-1.4,6.5,0,.2,0,2.6,2.1,4,1.5,1,3.4,1,5,.1,1.1-.6,3.3-2.1,5-4.8,2-3.2,2.1-6.2,2.1-7.5,0-.7-.2-2-1.1-3-1.4-1.4-3.8-1.9-6-1Z" /> <path d="M114.19,204.1c-.5,.2-1.7,1-2.5,2.5-.6,1.2-.6,2.3-.6,2.9,0,.1,0,1.2,.9,1.8,.6,.4,1.5,.4,2.2,0,.5-.3,1.4-.9,2.2-2.1,.9-1.4,.9-2.7,.9-3.3,0-.3-.1-.9-.5-1.3-.6-.7-1.6-.9-2.6-.5Z" /> <path d="M114.19,206.9c-.1,.1-.4,.2-.5,.5s-.1,.5-.1,.6c0,0,0,.2,.2,.4,.1,.1,.3,.1,.5,0,.1-.1,.3-.2,.5-.4,.2-.3,.2-.6,.2-.7s0-.2-.1-.3c-.2-.1-.5-.2-.7-.1Z"/></g>',
